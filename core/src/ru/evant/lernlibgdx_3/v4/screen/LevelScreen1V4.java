...
public class LevelScreen1V4 extends BaseScreenV4 {
    ...
    public void update(float dt) {
        ...
        if (starfishActors.size() == 0 && !win) {
            ...
            BaseActorV4 continueGame = new BaseActorV4(0,0, mainStage);
            continueGame.loadTexture( "message-continue.png" );
            continueGame.centerAtPosition(400,300);
            continueGame.moveBy(0,-100);
            continueGame.alignCamera();

            if (Gdx.input.isKeyPressed(Input.Keys.C)) StarfishGameV4.setActiveScreen( new LevelScreen2V4());
        }
    }
}
