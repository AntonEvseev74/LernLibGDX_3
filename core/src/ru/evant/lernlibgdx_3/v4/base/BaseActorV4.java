...
public class BaseActorV4 extends Actor {
    ...
    public BaseActorV4(float x, float y, Stage s) {
    ...
    */
    ...
    public static void setWorldBounds(BaseActorV4 ba) {
    ...
    public void centerAtActor(BaseActorV4 other) {
    ...
    public boolean overlaps(BaseActorV4 other) {
    ...
    public Vector2 preventOverlap(BaseActorV4 other) {
        Polygon poly1 = this.getBoundaryPolygon();
        Polygon poly2 = other.getBoundaryPolygon();
